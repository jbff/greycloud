...
class TestGreyCloudClient:
    ...
    def test_generate_content(self, sample_config, sample_contents, mock_generate_response):
    ...
    def test_generate_content_with_overrides(self, sample_config, sample_contents, mock_generate_response):
    ...
    def test_generate_content_stream(self, sample_config, sample_contents):
        ...
        with patch('greycloud.client.create_client') as mock_create:
            mock_genai_client = MagicMock()
            mock_genai_client.models.generate_content_stream.return_value = [mock_chunk1, mock_chunk2]
            mock_create.return_value = mock_genai_client
    ...
    def test_count_tokens_with_system_instruction(self, sample_config, sample_contents):
        ...
        with patch('greycloud.client.create_client') as mock_create:
            ...
            client = GreyCloudClient(sample_config)
            count = client.count_tokens(sample_contents, system_instruction="System prompt")
    ...
    def test_generate_with_retry_success(self, sample_config, sample_contents, mock_generate_response):
    ...
    def test_generate_with_retry_after_failure(self, sample_config, sample_contents, mock_generate_response):
    ...
    def test_generate_with_retry_auth_error(self, sample_config, sample_contents, mock_generate_response):
    ...
    def test_generate_with_retry_max_retries_exceeded(self, sample_config, sample_contents):
        """Test generate_with_retry when max retries exceeded"""
        with patch('greycloud.client.create_client') as mock_create:
            mock_genai_client = MagicMock()
            mock_genai_client.models.generate_content.side_effect = Exception("Persistent error")
            mock_create.return_value = mock_genai_client
            ...
            assert mock_genai_client.models.generate_content.call_count == 3  # Initial + 2 retries
